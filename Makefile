...
CP=jython-2.7b1.jar:/usr/lib/hbase/lib/hadoop-core.jar:/usr/lib/hive/lib/commons-cli-1.2.jar:/usr/lib/hbase/hbase-0.90.6-cdh3u4.jar:akela-0.5-SNAPSHOT.jar
#export HADOOP_USER_CLASSPATH_FIRST="true"
# this will need to change once more jars are added
#export HADOOP_CLASSPATH=jyson-1.0.2.jar
...
hadoop: WordCount.jar
	...
	time hadoop jar $< org.apache.hadoop.examples.WordCount -libjars jython-2.7b1.jar input output
