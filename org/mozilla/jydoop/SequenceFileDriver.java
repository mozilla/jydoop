...
public class SequenceFileDriver extends Configured implements Tool {
  ...
  public static class MyMapper extends Mapper<Text, Text, PythonKey, PythonValue>  {
    ...
    public void setup(Context context) throws IOException, InterruptedException
    {
      ...
      // TODO: get dirname, startdate enddate
  ...
  private SequenceFileDriver() {}                               // singleton
  ...
  public int run(String[] args) throws Exception {
    ...
    String jobname = "SequenceFileDriver: " + StringUtils.join(args, " ");

    Job job = new Job(conf, jobname);
    job.setJarByClass(SequenceFileDriver.class);     // class that contains mapper
    try {
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new SequenceFileDriver(), args);
    System.exit(res);
  }
